...
const styles = StyleSheet.create({
  ...
  imagen: {width: 80, height: 80, marginRight: 20},
  ...
  nombre: {fontSize: 22, color: '#64748b', marginBottom: 5},
  cantidad: {fontSize: 20, fontWeight: '700'},
  fecha: {fontWeight: '700', color: '#db2777'},
});
